...
const blogPosts = [
  ...
  },
  {
    ...
    excerpt: "Explore advanced Node.js concepts and learn how to build robust backend services with modern practices.",
    date: "March 10, 2024",
  ...
  },
  {
    ...
    excerpt: "Deep dive into TypeScript features and how to leverage them effectively in your frontend projects.",
    date: "March 5, 2024",
    readTime: "6 min read",
    image: "/placeholder.svg",
  ...
  return (
    <section id="blog" className="py-20">
      <Container>
        ...
        >
          <motion.div variants={fadeUpVariant} className="flex flex-col items-center space-y-4 text-center">
